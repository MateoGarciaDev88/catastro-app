...
import { useCreateOwner, useEditOwner } from '../../graphql/owners/customHooks';
...
export default function ModalFormOwners({ modalVisible, setModalVisible, ownerEdit, isEditing }) {
